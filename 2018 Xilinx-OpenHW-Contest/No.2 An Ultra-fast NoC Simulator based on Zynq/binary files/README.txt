...
#
# Generated by export_simulation on Fri Nov 24 23:39:25 +0800 2017
#
################################################################################
...
switch to the './FIFO_output.sh' script.

./FIFO_output.sh -reset_run
...
./FIFO_output.sh -noclean_files

For more information on the script, please type './FIFO_output.sh -help'.
